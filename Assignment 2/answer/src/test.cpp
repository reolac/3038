...

{
	...
	try
	{
		...
		*/
		...
		// Task 3: Histogram
		input_1.getHistogram(10, "task3.dat");
		std::cout << "Histogram saved at \"/task3.dat\"." << std::endl; 
		...
		// Task 6: Resize
		Image task_6 = input_1;
		task_6 = task_6.resizeImage(2);
		task_6.savePGM("task6.pgm");
